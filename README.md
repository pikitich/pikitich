...
![Profile views counter](https://komarev.com/ghpvc/?username=pikitich&&style=flat-square)
...
- 🔎  Я ручной тестировщик. Имею большой опыт в тестировании программного обеспечения, проверке функциональности и исправлении ошибок. Я обладаю прекрасными навыками анализа и опытом в использовании различных инструментов QA. 

- ⚡ Изучаю автотесты на Cypress и Selenium + Allure  

- 🛹 Летом катаюсь на лонгборде и классической доске, зимой играю в видеоигры.   
